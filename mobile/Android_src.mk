...
LOCAL_CFLAGS   := -O0 -g -funsigned-char  -DUSE_OPENGL -DHAVE_SOFTPOLY -DNO_CLOCK_GETTIME -DUSE_GL_HW_BUFFERS -fvisibility=hidden -frtti  -D__MOBILE__  -DOPNMIDI_DISABLE_GX_EMULATOR -DGZDOOM  -DGZDOOM_GL3 -D__STDINT_LIMITS -DENGINE_NAME=\"gzdoom_dev\"
#-DNO_PIX_BUFF
#-DUSE_GL_HW_BUFFERS
#-DHAVE_VULKAN
#-DUSE_GL_HW_BUFFERS
...
LOCAL_C_INCLUDES := \
	...
	$(GZDOOM_TOP_PATH)/source/libsmackerdec/include \
...
LOCAL_STATIC_LIBRARIES :=  SDL2_net zlib_gl3 lzma_gl3 gdtoa_gl3  bzip2_gl3 logwritter jpeg vpx
